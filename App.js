...
import { geocodeDepok, distanceMeters } from "./utils/geo";
import { STORAGE_HISTORY, STORAGE_TODAY, GROUP_RADIUS_M } from "./constants/depok";
...
export default function App() {
  ...
  // 🔹 Load lokasi GPS sekali saat start
  useEffect(() => {
    (async () => {
